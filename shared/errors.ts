...
export const ERROR_MESSAGES: Record<GenerationErrorCode, string> = {
  ...
  UNSUPPORTED_FORMAT:
    'Formato de archivo no soportado. Usa JPG, PNG, HEIC, PDF o texto plano.',
  FILE_TOO_LARGE:
    'El archivo es muy grande (máx. 50 MB). Intenta con un archivo más pequeño.',
  FILE_TOO_SMALL: 'El archivo es muy pequeño o está vacío. Prueba con otro archivo.',
  TRANSCRIPTION_FAILED:
    'No pudimos leer el archivo. Intenta con mejor iluminación o un PDF diferente.',
  INSUFFICIENT_CONTENT:
    'Este material tiene muy poco texto para generar una sesión. Prueba con apuntes más completos.',
  EXTRACTION_FAILED:
    'No pudimos extraer los conceptos clave. Intenta con material más estructurado.',
  GENERATION_FAILED:
    'Error al generar la sesión. Intenta nuevamente en unos momentos.',
  GROUNDING_VALIDATION_FAILED:
    'No pudimos validar que el contenido provenga de tu material. Intenta con otro archivo.',
  UNKNOWN_ERROR:
    'Algo salió mal. Por favor intenta nuevamente o contacta con soporte.',
};

export const ERROR_DETAILS: Record<GenerationErrorCode, string> = {
...
export function getErrorMessage(code: GenerationErrorCode): string {
  return ERROR_MESSAGES[code] ?? ERROR_MESSAGES.UNKNOWN_ERROR;
}

export function getErrorDetails(code: GenerationErrorCode): string {
